...
public class NearBenefitModel {
	...
	public NearBenefitModel(int serversNumber, double fairness_index, int[][] adjacencyMatrix, int[][] userCovered,
...
//					mAllBenefits = mAllBenefits/mValidUserList.size();
	...
	private int bubbleServerWithMaximumIncreasingUncoveredUsers() {
		...
		for (EdgeServer server : mServers) {
			...
			double newcu = server.getnewbenefitWithinOneHopNotInTheListAndDirectCovered(mValidUserList, mSelectedServerList,
