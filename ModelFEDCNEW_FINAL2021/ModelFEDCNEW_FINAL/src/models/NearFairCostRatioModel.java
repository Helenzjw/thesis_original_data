...
public class NearFairCostRatioModel {
	...
	public NearFairCostRatioModel(int serversNumber, double fairness_index, int[][] adjacencyMatrix, int[][] userCovered,
	...
	public void runNearFairCostRatio() {
	...
	private int bubbleServerWithMaximumIncreasingUncoveredUsers(int cost) {
		...
		for (EdgeServer server : mServers) {
			...
			double newcu = server.getnewfairnesscostratioWithinOneHopNotInTheListAndDirectCovered(mValidUserList, mSelectedServerList,
